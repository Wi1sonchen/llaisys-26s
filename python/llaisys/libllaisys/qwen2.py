...
def load_qwen2(lib):
    ...
    lib.llaisysQwen2ModelAllWeightsLoaded.argtypes = [llaisysQwen2Model_t]
    lib.llaisysQwen2ModelAllWeightsLoaded.restype = c_int

    lib.llaisysQwen2ModelResetCache.argtypes = [llaisysQwen2Model_t]
    lib.llaisysQwen2ModelResetCache.restype = None

    lib.llaisysQwen2ModelCacheLength.argtypes = [llaisysQwen2Model_t]
    lib.llaisysQwen2ModelCacheLength.restype = c_size_t
